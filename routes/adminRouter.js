...
router.post("/addUserAdmin", auth, adminCtrl.addUser);
router.patch("/editUserAdmin", auth, adminCtrl.editUserProfile);
router.patch("/changePasswordAdmin", auth, adminCtrl.changeUserPassword);

router.get("/getAllUsers", auth, adminCtrl.getAllUsers);
